var BrowserEngine = function BrowserEngine(data) {
  ...
  this.isOpera = function() {
    return this.name.indexOf("Opera") !== -1 || additional.indexOf("Opera") !== -1;
  };
  ...
  this.isIE = function() {
    return this.name.indexOf("MSIE") !== -1 || additional.indexOf("MSIE") !== -1 || this.name.indexOf("Edge") !== -1 || additional.indexOf("Edge") !== -1;
  };
};
